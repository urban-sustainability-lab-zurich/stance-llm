...
### is
![is_prompt_illu](images/is_prompt_illu.png)
...
### sis
![sis_prompt_illu](images/sis_prompt_illu.png)
...
### nise
![nise_prompt_illu](images/nise_prompt_illu.png)
...
### s2
![s2_prompt_illu](images/s2_prompt_illu.png)
...
### is2
![is2_prompt_illu](images/is2_prompt_illu.png)
...
### s2is
![s2is_prompt_illu](images/s2is_prompt_illu.png)
...
### nis2e
![nis2e_prompt_illu](images/nis2e_prompt_illu.png)
1. prompts the LLM if there is a (general) stance of the detected actor in the text, if not: stance=irrelevant
2. prompts the LLM whether the stance of the actor has a relation to the statement, or not, if not: stance=irrelevant
